            ...
            >
              ...
              <div className="relative">
                <button
                    ...
                    className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white border rounded-full p-2 shadow hover:bg-gray-100"
                  >
                    <FaChevronLeft />
                  </button>
                ...
                >
                  {items.map((product) => (
                    <motion.div
                      key={product.id}
                      className="min-w-[200px] sm:min-w-[220px] md:min-w-[240px] lg:min-w-[250px] flex-shrink-0"
               ...
               <button
                    ...
                    className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white border rounded-full p-2 shadow hover:bg-gray-100"
                  >
                    <FaChevronRight />
                  </button>
